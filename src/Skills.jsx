...
function Skills() {
  return (
    ...
    >
      <Box sx={{ position: "relative", zIndex: 1, width: "100%", px: { xs: 1, sm: 2 } }}>
        {/* Title */}
        <Grid
          container
        ...
        >
          ...
          <Grid item xs={6} sm={6} md={3} sx={{ display: "flex", justifyContent: "center" }}>
            <Card sx={cardStyle}>
              ...
              <List dense disablePadding>
                ...
                />
                <SkillItem 
                  icon={<StyleIcon sx={{ color: "#38bdf8" }} fontSize="small" />} 
                  text="Tailwind CSS" 
                />
              </List>
            </Card>
          ...
          <Grid item xs={6} sm={6} md={3} sx={{ display: "flex", justifyContent: "center" }}>
            <Card sx={cardStyle}>
              ...
              <List dense disablePadding>
                <SkillItem 
                  icon={<JavascriptIcon sx={{ color: "#f7df1e" }} fontSize="small" />} 
                  text="JavaScript (ES6+)" 
                />
                <SkillItem 
          ...
          <Grid item xs={6} sm={6} md={3} sx={{ display: "flex", justifyContent: "center" }}>
            <Card sx={cardStyle} >
              ...
              <List dense disablePadding>
                ...
                />
                <SkillItem 
                  icon={<DesignServicesIcon color="secondary" fontSize="small" />} 
                  text="Figma" 
                />
              </List>
            </Card>
          ...
          <Grid item xs={6} sm={6} md={3} sx={{ display: "flex", justifyContent: "center" }}>
            <Card sx={cardStyle}>
              ...
              <List dense disablePadding    sx={{ fontSize: { xs: "0.8rem", sm: "0.95rem", md: "1rem" } }}>
                <SkillItem 
...
const cardStyle = {
  ...
  "&:hover": {
    transform: { xs: "translateY(-4px)", sm: "translateY(-4px)", md: "scale(1.05)" },

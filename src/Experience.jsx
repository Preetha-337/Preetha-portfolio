        ...
        <Grid>
          ...
          >
            ...
            <Box sx={{ p: 2 }}>
              ...
              >
                MERN Stack Developer with hands-on experience in designing,
                developing, and optimizing responsive web applications using
                React.js, React Native, JavaScript (ES6+), HTML5, CSS3,
                Bootstrap, and Material UI. Skilled in creating intuitive user
                interfaces, integrating REST APIs with Node.js, and ensuring
                seamless cross-device and cross-browser experiences.
              </Typography>
            </Box>
          </Card>
        </Grid>

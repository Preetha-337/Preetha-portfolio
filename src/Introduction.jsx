...
function Introduction() {
  return (
    ...
    >
      {/* Title Section */}
      <Grid item xs={12} sx={{ position: "relative", zIndex: 1, mt: 4, textAlign: "center",ml:{xs:14,sm:2} }}>
        <Typography
          variant="h6"
          fontWeight="bold"
          sx={{ color: "primary.main", fontSize: { xs: "1.1rem", sm: "1.25rem", md: "1.4rem" } }}
        >
          ABOUT ME
        </Typography>
      </Grid>
      ...
      >
        ...
        <Grid container item xs={12} md={10} lg={8} spacing={3}sx={{ display: "flex", flexDirection: {xs:"column",md:"column"}}} >
          {/* Left Column - Two Cards stacked vertically */}
          <Grid item xs={12} md={6} gap ={5} sx={{ display: "flex", flexDirection: {xs:"column",md:"row" }}}>
            {/* About Text Card */}
            <Card
              elevation={4}
              sx={{
